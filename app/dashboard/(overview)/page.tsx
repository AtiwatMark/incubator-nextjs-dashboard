...
import DashboardSkeleton, { CardSkeleton, LatestInvoicesSkeleton, RevenueChartSkeleton } from "../../ui/skeletons";
    ...
    return (
        <div className="w-full">
            ...
            <div className="gap-4 grid grid-cols-4 mt-6">
                ...
                <Card title="Collector" value={totalPaidInvoices} type="collected"/>
